                ...
                <div className="flex-main-content">
                    ...
                    <div className="main-container fade-in">
                        ...
                        <div className="right-side">
                            <img src="app/assets/images/template/intro.png" draggable="false" draggable="false"/>
              ...
              <div className="intro white">
                <div className="flex-main-content">
                    ...
                    <div className="main-container fade-in">
                        ...
                        <div className="right-side">
                            <img src="app/assets/images/template/intro.png" draggable="false"/>
                            <div className="img-text-grp"><span className="text-red">Kai =</span><span className="text-blk">Change</span> </div>
                            <div className="img-text-grp"><span className="text-red">Zen =</span><span className="text-blk">Good</span> </div>
                        </div>
                    </div>
                ...
                <div className="flex-main-content">
                    ...
                    <div className="container_sm fade-in">
                        ...
                        <div className="image_blk_sm">
                            <img src="app/assets/images/template/scrn1_img_sm.png" draggable="false"/>
                            <div className="img-text-grp"><span className="text-red">Kai =</span><span className="text-blk">Change</span> </div>
                            <div className="img-text-grp"><span className="text-red">Zen =</span><span className="text-blk">Good</span> </div>
                        </div>
                    </div>
